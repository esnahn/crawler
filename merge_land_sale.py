...
# 1) 소스 파일 목록
input_pattern = f"data/downloads/{prefix}_*.csv"
...
delayed_dfs = [read_csv_from_realtx(fp) for fp in file_paths]
...
# 5) 결과 저장 (utf-8-sig)
output_path = f"data/{prefix}_all.csv"
